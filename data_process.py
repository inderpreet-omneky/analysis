...
class Data(AdData):
    def __init__(self, data,mode = "binary"):
        print("inside here-----------------------")
        cols=data.columns
        print("inside data proces---------------------")
        print("columns before processing",cols)
        if ('image_entities' in cols) and ('video_entities' in cols):
            print("inside both entities")
            self._LISTVARS = ['title_entities','video_entities','body_entities','image_entities']
            self._df = data
            entities = ['title_entities','video_entities','body_entities','image_entities']
        elif 'image_entities' in cols:
            print("this condition is true------------------------------------------")
            self._LISTVARS = ['title_entities','image_entities','body_entities']
            self._df = data
            entities = ['title_entities','image_entities','body_entities']
        elif 'video_entities' in cols:
            print("inside data process video entities")
            self._LISTVARS = ['title_entities','video_entities','body_entities']
            self._df = data
            entities = ['title_entities','video_entities','body_entities']
    ...
    def get_binaries_for_entities(self, entity):
        ...
        if entity in ['nlp_link_description_entities','nlp_asset_entitites','nlp_body_entities','vid_text_entities','title_entities','video_entities','body_entities','image_entities']:
